...
class Assistant_Nav_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding = ActivityAssistantNavBinding.inflate(layoutInflater)
        setContentView(mBinding.root)

        // 네비게이션들을 담는 호스트
        val navHostFragment = supportFragmentManager.findFragmentById(R.id.assist_nav_host) as NavHostFragment
        ...
        NavigationUI.setupWithNavController(mBinding.assistBottomNav, navController)
