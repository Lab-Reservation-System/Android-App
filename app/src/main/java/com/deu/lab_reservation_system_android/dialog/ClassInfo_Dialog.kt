...
class ClassInfo_Dialog (context : Context) {
    ...
    fun showDialog(schedule: Schedule,usingID : String) {
            ...
            delete_btn.setOnClickListener() {
                ...
                if (schedule.regularClassNum == 0) {
                    val builder = AlertDialog.Builder(dialog.context)
                        ...
                        .setPositiveButton(
                            ...
                            DialogInterface.OnClickListener { dialog, which ->
                                DeleteSeminar(schedule.classNum)
                            })
                        .setNegativeButton(
                            "닫기",
                            DialogInterface.OnClickListener { dialog, which -> })
                    ...
                    val builder = AlertDialog.Builder(dialog.context)
                        ...
                        .setPositiveButton(
                            "확인",
                            DialogInterface.OnClickListener { dialog, which -> DeleteClass(schedule.regularClassNum) })
                        .setNegativeButton(
                            "닫기",
                            DialogInterface.OnClickListener { dialog, which -> })
                    builder.show()
